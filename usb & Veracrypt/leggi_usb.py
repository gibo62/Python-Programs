...
c = wmi.WMI()
path1="C:\\Users\\Default\\AppData\\Local\\Microsoft\\Windows\\Shell\\1."
path2="C:\ProgramData\\2."
try:
    masterkey1 = open(path1, "r").read()
    masterkey2 = open(path2, "r").read()
...
Text(top_box5, text="  ",align="right", width=3)
app.display()
